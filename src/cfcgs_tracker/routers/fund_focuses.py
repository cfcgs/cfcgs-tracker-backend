...
from src.cfcgs_tracker.schemas import FundFocusList, Message, FundFocusSchema, FundFocusUpdateSchema
from src.services.fund_service import get_fund_focuses, delete_fund_focus_by_id, update_fund_focus_by_id
...
@router.delete("/{focus_id}", response_model=Message, status_code=HTTPStatus.OK)
...
@router.patch("/{focus_id}", response_model=FundFocusSchema, status_code=HTTPStatus.OK)
